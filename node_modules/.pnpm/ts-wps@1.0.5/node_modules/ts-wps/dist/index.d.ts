...
/**
 * WebOffice开放平台新增Options
 */
interface IAppConfig extends IConfig { 
  appId: string
  fileId: string | number
  officeType: string
  fileToken?: string | tokenData
  endpoint?: 'https://o.wpsgo.com' | string
...
export { IAppConfig, ICommonOptions, IConfig, IDBOptions, IEtOptions, IFlag, IIframeWH, IMessage, IOtlOptions, IPDFOptions, ISubscriptionsConf, IUserHeaderButtonConf, IUserHeaderSubItemsConf, IUserHeadersConf, IWppOptions, IWps, IWpsCommandBarAttr, IWpsCommandBarObjectAttr, IWpsCommandBars, IWpsOptions, IWpsWebApi, OfficeType, TGetClipboardData, clipboardData, tokenData };
